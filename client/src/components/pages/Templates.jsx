      ...
      <div className="templates-list">
        ...
        <div className="template-create-card primary-accent" onClick={handleOpenCreate}>
          ...
          <div className="create-content">
            <div className="create-title">Create a New Template</div>
          ...
          sortedTemplates.map((item) => (
            <div key={item.id} className="template-card">
              ...
              <div className="template-actions-footer">
                <button className="action-link edit" onClick={(e) => handleEditClick(e, item)} aria-label="Edit template" title="Edit">
                ...
                <button className="action-link delete" onClick={(e) => handleDeleteClick(e, item.id)} aria-label="Delete template" title="Delete">
