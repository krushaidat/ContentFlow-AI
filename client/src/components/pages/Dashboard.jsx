...
/**
 * ensureDriveConnected — checks if the user already has an active Drive
 * connection. If not, it starts OAuth and returns false so the current
 * action can stop until the user finishes connecting.
 */
...
/**
 * handleOpenDriveBrowser — opens the Drive browser when connected.
 * If not connected yet, it redirects user into OAuth flow instead.
 */
